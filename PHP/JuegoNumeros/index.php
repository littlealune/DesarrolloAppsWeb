...
<body>
    <form action="juego.php" method="post">
        <fieldset>
            ...
            <h2>Soy capaz de acertar el número en los intentos establecidos</h2>
            <hr>
            <h2>Cada vez que te dé un número deberás indicarme:</h2>
            <ul>
                <li>Si el número es el adecuado</li>
                <li>Si el número mayor que el adecuado</li>
                <li>Si el número menor que el adecuado</li>
            </ul>
